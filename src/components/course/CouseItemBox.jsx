...
export const CourseItemBox = () => {
  return (
    <div className="flex gap-[17px] py-[12.5px] px-3 bg-white flex-1 rounded-[8px] shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] items-center border-[0.5px] border-[var(--color-bg)]">
